...
class XceptionS2(nn.Module):
    ...
    def __init__(self, in_channels, out_channels=1, num_sepconv_blocks=8, num_sepconv_filters=728, returns="targets",
                 ...
                 freeze_features=False, freeze_last_mean=False, freeze_last_var=True, geo_shift=False, geo_scale=False,
        ...
        if self.freeze_last_var: # freeze var
            print('Freeze last layer (var regressor)... args.freeze_last_mean={}'.format(self.freeze_last_var))
