...
from utils.gdal_process import save_array_as_geotif
from utils.parser import load_args_from_json, str2bool, str_or_none
from utils.aws import download_and_zip_safe_from_aws
...
def setup_parser():
    ...
    parser.add_argument("--model_id", default=0, help="id of the used model", type=int)
...
if __name__ == "__main__":
    ...
    print(args.channels, args.input_lat_lon)
    # ----------------------------------------
    ...
    print('train_input_mean', train_input_mean.shape)
    print('train_input_std', train_input_std.shape)

    print('train_target_mean', train_target_mean.shape)
    print('train_target_std', train_target_std.shape)
    ...
    architecture_collection = Architectures(args=args, returns='targets')
