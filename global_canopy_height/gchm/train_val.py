...
if __name__ == "__main__":
    ...
    ds_train_raw = make_concat_dataset(paths_h5=paths_h5_train, input_lat_lon=True)
    ...
    if args.normalize_targets:
        if not os.path.exists(os.path.join(args.data_stats_dir, 'train_target_mean.npy')):
            print('computing target statistics on training data normalize...')
    ...
    print("Freeze var:", args.freeze_last_var)
    print("Return var:", args.return_variance)
    print("Loss key", args.loss_key)
